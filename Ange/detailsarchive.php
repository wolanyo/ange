...
?>
<div id="here">
    Vous &ecirc;tes ici :  <a href="principale.php?page=accueil">Accueil</a> > <a href="principale.php?page=archives">Archive</a> > <a href="">D&eacute;tails du courrier</a>
</div>
    ...
    <p class="lienbt">
        <?php
            if( $idUserLogged == $idUserCourrier || $droit == "admin" ){
                if( $idUserLogged == $idUserCourrier || $droit == "admin" )
                	echo '<a class="btn btn-success" href="#" id="desarchiver" >Desarchiver</a> ';
